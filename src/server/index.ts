...
import { initializeSocketIO } from '../lib/realtime/socket.ts';
import { initRedisClient } from '../lib/cache/redis.ts';
import { initElasticsearchClient, createResourceIndex } from '../lib/search/elasticsearch.ts';
import { redisConfig, elasticsearchConfig, localStorageConfig } from '../lib/config/services.ts';
